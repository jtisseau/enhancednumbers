 ...
 */
class modEnhancedNumbers extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'enhancednumbers';
		...
		$this->picto = 'counter@enhancednumbers'; // mypicto@mymodule
		...
		$this->module_parts = array(
			...
			'css' => array('enhancednumbers/css/enhancednumbers.css'), 
		...
		$this->langfiles = array("enhancednumbers@enhancednumbers");
		// Constants
		...
		// Dictionaries
		if (! isset($conf->enhancednumbers->enabled)) {
			$conf->enhancednumbers=new stdClass();
			$conf->enhancednumbers->enabled = 0;
		}
