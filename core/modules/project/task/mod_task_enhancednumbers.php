...
/**
 *	\file       htdocs/custom/enhanccednumbers/core/modules/project/mod_project_universal.php
 *	\ingroup    project
 ...
 */
class mod_task_enhancednumbers extends ModeleNumRefTask
{
	...
	function info()
    {
		...
		$texte.= '<input type="hidden" name="maskconsttask" value="PROJECT_TASK_ENHANCEDNUMBERS_MASK">';
		$texte.= '<table class="nobordernopadding" width="100%">';
		$texte.= '<tr><td>'.$langs->trans("Mask").':</td>';
		$texte.= '<td align="right">'.$form->textwithpicto('<input type="text" class="flat" size="24" name="masktask" value="'.$conf->global->PROJECT_TASK_ENHANCEDNUMBERS_MASK.'">',$tooltip,1,1).'</td>';
	...
	*/
    function getNextValue($objsoc, $project)
    {
		...
		$mask = $conf->global->PROJECT_TASK_ENHANCEDNUMBERS_MASK;
		...
		return enhancednumbers_get_next_value($db, $mask, 'projet_task', 'ref', '', $objsoc, $project->date_c);
	}
