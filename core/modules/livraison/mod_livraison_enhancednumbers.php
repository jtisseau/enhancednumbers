...
/**
 *	\file       htdocs/core/modules/livraison/mod_livraison_enhancednumbers.php
 *	\ingroup    expedition
...
/**
 *	\class      mod_livraison_enhancednumbers
 *	\brief      Class to manage delivery numbering rules EnhancedNumbers
 */
class mod_livraison_enhancednumbers extends ModeleNumRefDeliveryOrder
{
	...
	function info()
	{
		...
		$texte .= '<input type="hidden" name="maskconstdelivery" value="LIVRAISON_ENHANCEDNUMBERS_MASK">';
		$texte .= '<table class="nobordernopadding" width="100%">';
		$texte .= '<tr><td>'.$langs->trans("Mask").':</td>';
		$texte .= '<td align="right">'.$form->textwithpicto('<input type="text" class="flat" size="24" name="maskdelivery" value="'.$conf->global->LIVRAISON_ENHANCEDNUMBERS_MASK.'">', $tooltip,1,1).'</td>';
    ...
    function getNextValue($objsoc, $object)
    {
		...
		$mask = $conf->global->LIVRAISON_ENHANCEDNUMBERS_MASK;
		...
		return enhancednumbers_get_next_value($db, $mask, 'livraison', 'ref', '', $objsoc, $object->date_livraison);
    }
